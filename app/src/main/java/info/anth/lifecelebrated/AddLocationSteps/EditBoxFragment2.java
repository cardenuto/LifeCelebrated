 ...
 *
 */
public class EditBoxFragment2 extends Fragment {
    ...
    public static final String LOG_TAG = EditBoxFragment2.class.getSimpleName();
    ...
    public EditBoxFragment2() { }

    /**
     * Returns a new instance of this fragment for the given page
     * number.
     */
    public static EditBoxFragment2 newInstance(int pageNumber, String firebaseEditStatus, String firebaseEditMaster, String firebaseEditList) {
        EditBoxFragment2 fragment = new EditBoxFragment2();
